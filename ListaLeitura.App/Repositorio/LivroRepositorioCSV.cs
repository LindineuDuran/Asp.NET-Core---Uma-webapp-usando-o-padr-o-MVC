...
namespace ListaLeitura.App.Repositorio
{
    ...
    {
        private static readonly string nomeArquivoCSV = "D:\\GitHub\\C#\\ListaLeitura\\ListaLeitura.App\\Repositorio\\livros.csv";
        ...
        ListaDeLeitura ILivroRepositorio.ParaLer => throw new NotImplementedException();

        ListaDeLeitura ILivroRepositorio.Lendo => throw new NotImplementedException();

        ListaDeLeitura ILivroRepositorio.Lidos => throw new NotImplementedException();

        IEnumerable<Livro> ILivroRepositorio.Todos => throw new NotImplementedException();
